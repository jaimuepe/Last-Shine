...
Shader "custom/ddTVStatic"
{
	Properties
	{
		...
		_ResX("X Resolution", Float) = 1
		_ResY("Y Resolution", Float) = 1

		_ScaleWithZoom("Scale With Cam Distance", Range(0,1)) = 1.0

		_TimeD("_Time_d", float) = 0
...
#include "UnityCG.cginc"
	...
	{
		return frac((sin(dot(co.xy , float2(12.345 * _TimeD, 67.890 * _TimeD))) * 12345.67890 + _TimeD));
	}
